...
public class LanChatSettingsDefinition implements SettingsDefinition {
    ...
    private void defineInternalSettings() {
        ...
        settings.add(new Config.Setting(SettingKeys.UPD_PREFIX, "update:", null, Config.SettingType.RAW, false, true));
        settings.add(new Config.Setting(SettingKeys.RSP_PREFIX, "hello:", null, Config.SettingType.RAW, false, true));
